    ...
    <div class="container" style="padding-top:150px;">
      ...
      // $conn = new mysqli($hostname, $username, $password, $database);
                      ...
                      else
                      {
                        ...
                        $admin_username= test_input($conn,$_POST['adminUserName']);
                        $admin_password= test_input($conn, $_POST['adminPassword']);
                        ...
                        $sql= "SELECT * FROM simple_voting_system.tbl_admin WHERE admin_username='".$admin_username."' AND admin_password='".$admin_password."'";
